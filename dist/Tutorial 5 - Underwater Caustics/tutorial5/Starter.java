...
public class Starter extends JFrame implements GLEventListener, KeyListener {
    ...
    public Starter(int width, int height) {
        super("Tutorial 5 - Underwater Caustics");
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        geometryShaderProgram = Utils.createShader("tutorial5/geometry.vs.glsl", "tutorial5/geometry.fs.glsl");
        waterShaderProgram = Utils.createShader("tutorial5/water.vs.glsl", "tutorial5/water.fs.glsl");
        underwaterShaderProgram = Utils.createShader("tutorial5/underwater.vs.glsl", "tutorial5/underwater.fs.glsl");
